...
<style type="text/css">
   ...
   .why_section .box3{
      ...
      <!-- caraousell slide foto -->
      <div class="hero_area">

         <!-- Caraousell slide 1 -->
         <section class="slider_section ">
            <div class="slider_bg_box">
               <img src="{{asset('Template/images/wedding.jpg')}}" alt="">
            </div>
               ...
               <div class="col-md-4">
                  <div class="box box1">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Menyediakan banyak service yang dapat disewa
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box box2 ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Terdapat banyak pilihan tema organizer
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box box3 ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Menyediakan kualitas tebaik organizer
                        </p>
                     </div>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="box" style="height: fit-content;">
               <div class="arrival_bg_box">
                  <img src="{{asset('Template/images/categorie.png')}}" alt="">
               </div>
               <div class="row">
            ...
            <div class="row">
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="img-box">
                        <img src="{{asset('Template/images/m1.png')}}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           Kemeja Putih
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="img-box">
                        <img src="{{asset('Template/images/w1.png')}}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           Sepatu Putih
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="img-box">
                        <img src="{{asset('Template/images/m2.png')}}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           Pentopel Hitam
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="img-box">
                        <img src="{{asset('Template/images/w10.png')}}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           Gaun Putih
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="img-box">
                        <img src="{{asset('Template/images/a1.png')}}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           Mahkota Emas
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="img-box">
                        <img src="{{asset('Template/images/d1.png')}}" alt="">
                     </div>
                     <div class="detail-box">
                        <h5>
                           Set Dekorasi
